...
export default function JapanMap({ animeCounts }: JapanMapProps) {
  ...
  const getFill = (slug: string) => {
    const hasAnime = (animeCounts[slug] || 0) > 0;
    const isHovered = hoveredPrefecture === slug;

    if (isHovered) {
      return hasAnime ? "#818cf8" : "#d1d5db";
    }
    return hasAnime ? "#6366f1" : "#e5e7eb";
  };
  ...
  return (
    <div className="relative">
        ...
        <g transform="matrix(1.028807, 0, 0, 1.028807, -47.544239, -28.806583)">
          <g transform="matrix(1, 0, 0, 1, 6, 18)" id="prefectures">
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("hokkaido")}
              onMouseEnter={() => handleMouseEnter("hokkaido")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("hokkaido")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("aomori")}
              onMouseEnter={() => handleMouseEnter("aomori")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("aomori")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("iwate")}
              onMouseEnter={() => handleMouseEnter("iwate")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("iwate")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("miyagi")}
              onMouseEnter={() => handleMouseEnter("miyagi")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("miyagi")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("akita")}
              onMouseEnter={() => handleMouseEnter("akita")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("akita")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("yamagata")}
              onMouseEnter={() => handleMouseEnter("yamagata")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("yamagata")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("fukushima")}
              onMouseEnter={() => handleMouseEnter("fukushima")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("fukushima")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("ibaraki")}
              onMouseEnter={() => handleMouseEnter("ibaraki")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("ibaraki")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("tochigi")}
              onMouseEnter={() => handleMouseEnter("tochigi")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("tochigi")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("gunma")}
              onMouseEnter={() => handleMouseEnter("gunma")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("gunma")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("saitama")}
              onMouseEnter={() => handleMouseEnter("saitama")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("saitama")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("chiba")}
              onMouseEnter={() => handleMouseEnter("chiba")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("chiba")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("tokyo")}
              onMouseEnter={() => handleMouseEnter("tokyo")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("tokyo")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("kanagawa")}
              onMouseEnter={() => handleMouseEnter("kanagawa")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("kanagawa")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("niigata")}
              onMouseEnter={() => handleMouseEnter("niigata")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("niigata")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("toyama")}
              onMouseEnter={() => handleMouseEnter("toyama")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("toyama")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("ishikawa")}
              onMouseEnter={() => handleMouseEnter("ishikawa")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("ishikawa")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("fukui")}
              onMouseEnter={() => handleMouseEnter("fukui")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("fukui")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("yamanashi")}
              onMouseEnter={() => handleMouseEnter("yamanashi")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("yamanashi")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("nagano")}
              onMouseEnter={() => handleMouseEnter("nagano")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("nagano")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("gifu")}
              onMouseEnter={() => handleMouseEnter("gifu")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("gifu")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("shizuoka")}
              onMouseEnter={() => handleMouseEnter("shizuoka")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("shizuoka")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("aichi")}
              onMouseEnter={() => handleMouseEnter("aichi")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("aichi")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("mie")}
              onMouseEnter={() => handleMouseEnter("mie")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("mie")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("shiga")}
              onMouseEnter={() => handleMouseEnter("shiga")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("shiga")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("kyoto")}
              onMouseEnter={() => handleMouseEnter("kyoto")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("kyoto")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("osaka")}
              onMouseEnter={() => handleMouseEnter("osaka")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("osaka")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("hyogo")}
              onMouseEnter={() => handleMouseEnter("hyogo")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("hyogo")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("nara")}
              onMouseEnter={() => handleMouseEnter("nara")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("nara")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("wakayama")}
              onMouseEnter={() => handleMouseEnter("wakayama")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("wakayama")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("tottori")}
              onMouseEnter={() => handleMouseEnter("tottori")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("tottori")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("shimane")}
              onMouseEnter={() => handleMouseEnter("shimane")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("shimane")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("okayama")}
              onMouseEnter={() => handleMouseEnter("okayama")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("okayama")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("hiroshima")}
              onMouseEnter={() => handleMouseEnter("hiroshima")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("hiroshima")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("yamaguchi")}
              onMouseEnter={() => handleMouseEnter("yamaguchi")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("yamaguchi")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("tokushima")}
              onMouseEnter={() => handleMouseEnter("tokushima")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("tokushima")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("kagawa")}
              onMouseEnter={() => handleMouseEnter("kagawa")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("kagawa")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("ehime")}
              onMouseEnter={() => handleMouseEnter("ehime")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("ehime")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("kochi")}
              onMouseEnter={() => handleMouseEnter("kochi")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("kochi")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("fukuoka")}
              onMouseEnter={() => handleMouseEnter("fukuoka")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("fukuoka")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("saga")}
              onMouseEnter={() => handleMouseEnter("saga")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("saga")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("nagasaki")}
              onMouseEnter={() => handleMouseEnter("nagasaki")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("nagasaki")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("kumamoto")}
              onMouseEnter={() => handleMouseEnter("kumamoto")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("kumamoto")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("oita")}
              onMouseEnter={() => handleMouseEnter("oita")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("oita")}
              stroke="#94a3b8"
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("miyazaki")}
              onMouseEnter={() => handleMouseEnter("miyazaki")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("miyazaki")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("kagoshima")}
              onMouseEnter={() => handleMouseEnter("kagoshima")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("kagoshima")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
            ...
            <g
              ...
              onClick={() => handlePrefectureClick("okinawa")}
              onMouseEnter={() => handleMouseEnter("okinawa")}
              onMouseLeave={handleMouseLeave}
              className="cursor-pointer transition-colors duration-200"
              fill={getFill("okinawa")}
              stroke="#94a3b8"
              strokeWidth="0.5"
            >
      ...
      {hoveredPrefecture && (
        <div
          className="absolute bg-gray-900 text-white px-3 py-2 rounded-md text-sm pointer-events-none whitespace-nowrap z-10"
          style={{
        ...
        >
          <div className="font-semibold">
            {prefectureBySlug.get(hoveredPrefecture)?.nameJa || hoveredPrefecture}
          </div>
          <div className="text-gray-300">
            {animeCounts[hoveredPrefecture] || 0} 作品
          </div>
        </div>
      )}
    </div>
