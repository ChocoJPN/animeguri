...
('tokyo', (SELECT id FROM anime WHERE slug = 'lovelive'), '秋葉原'),
('tokyo', (SELECT id FROM anime WHERE slug = 'lovelive'), 'UTX（ベルサール秋葉原）'),
-- 呪術廻戦
...
-- ぼっち・ざ・ろっく！
('tokyo', (SELECT id FROM anime WHERE slug = 'bocchi-the-rock'), '下北沢'),
-- 四月は君の嘘
('tokyo', (SELECT id FROM anime WHERE slug = 'shigatsu-wa-kimi-no-uso'), '練馬区周辺'),
-- 3月のライオン
('tokyo', (SELECT id FROM anime WHERE slug = 'sangatsu-no-lion'), '月島'),
('tokyo', (SELECT id FROM anime WHERE slug = 'sangatsu-no-lion'), '勝どき橋'),
-- 言の葉の庭
('tokyo', (SELECT id FROM anime WHERE slug = 'kotonoha-no-niwa'), '新宿御苑'),
-- リコリス・リコイル
('tokyo', (SELECT id FROM anime WHERE slug = 'lycoris-recoil'), '東京スカイツリー周辺'),
('tokyo', (SELECT id FROM anime WHERE slug = 'lycoris-recoil'), '浅草'),
-- デュラララ!!
('tokyo', (SELECT id FROM anime WHERE slug = 'durarara'), '池袋駅東口'),
('tokyo', (SELECT id FROM anime WHERE slug = 'durarara'), 'サンシャイン60通り'),
-- とある科学の超電磁砲
('tokyo', (SELECT id FROM anime WHERE slug = 'toaru-kagaku-no-railgun'), '立川駅周辺'),
('tokyo', (SELECT id FROM anime WHERE slug = 'toaru-kagaku-no-railgun'), '多摩モノレール'),
-- かぐや様は告らせたい
('tokyo', (SELECT id FROM anime WHERE slug = 'kaguya-sama'), '港区周辺（秀知院学園のイメージモデル）'),
('tokyo', (SELECT id FROM anime WHERE slug = 'kaguya-sama'), '六本木・赤坂エリア'),
-- 五等分の花嫁
('tokyo', (SELECT id FROM anime WHERE slug = 'gotoubun-no-hanayome'), '中野区・中野サンプラザ周辺'),
('tokyo', (SELECT id FROM anime WHERE slug = 'gotoubun-no-hanayome'), '太田市場'),
-- とらドラ！
('tokyo', (SELECT id FROM anime WHERE slug = 'toradora'), '西東京市・保谷駅周辺'),
('tokyo', (SELECT id FROM anime WHERE slug = 'toradora'), '練馬区・石神井公園'),
-- おそ松さん
('tokyo', (SELECT id FROM anime WHERE slug = 'osomatsu-san'), '中野ブロードウェイ（赤塚不二夫ゆかりの地）'),
('tokyo', (SELECT id FROM anime WHERE slug = 'osomatsu-san'), '青梅市・赤塚不二夫会館跡'),
-- CLANNAD
('tokyo', (SELECT id FROM anime WHERE slug = 'clannad'), '東京都羽村市周辺'),
-- 時々ボソッとロシア語でデレる隣のアーリャさん
('tokyo', (SELECT id FROM anime WHERE slug = 'roshidere'), '東京都内（学園モデル周辺）'),
-- 彼女、お借りします
('tokyo', (SELECT id FROM anime WHERE slug = 'kanokari'), '新宿区・歌舞伎町周辺'),
('tokyo', (SELECT id FROM anime WHERE slug = 'kanokari'), '板橋区周辺'),
-- 僕の心のヤバイやつ
('tokyo', (SELECT id FROM anime WHERE slug = 'bokuyaba'), 'あきる野市・秋川駅周辺'),
('tokyo', (SELECT id FROM anime WHERE slug = 'bokuyaba'), '秋川渓谷'),
-- ホリミヤ
('tokyo', (SELECT id FROM anime WHERE slug = 'horimiya'), '東京都内（舞台モデル周辺）'),
-- 冴えない彼女の育てかた
('tokyo', (SELECT id FROM anime WHERE slug = 'saekano'), '豊島区・池袋周辺'),
('tokyo', (SELECT id FROM anime WHERE slug = 'saekano'), '練馬区周辺'),
-- ニセコイ
...
-- 干物妹！うまるちゃん
('tokyo', (SELECT id FROM anime WHERE slug = 'himouto-umaru-chan'), '八王子駅周辺（舞台モデル）'),
-- 俺の妹がこんなに可愛いわけがない（秋葉原）
('tokyo', (SELECT id FROM anime WHERE slug = 'oreimo'), '秋葉原'),
-- 鬼滅の刃（東京）
('tokyo', (SELECT id FROM anime WHERE slug = 'kimetsu-no-yaiba'), '浅草寺周辺'),
-- 君の名は。（東京）
